...
fig.add_trace(go.Scatter(
    x=days,
    y=tempsJan,
    name= "January Temperature",
    line=dict(color="royalblue",width=4)
))
fig.add_trace(go.Scatter(
    x=days,
    y=tempsFeb,
    name= "Febuary Temperature",
    line=dict(color="darkblue",width=4)
))
fig.add_trace(go.Scatter(
    x=days,
    y=tempsJune,
    name= "June Temperature",
    line=dict(color="crimson",width=4)
))
fig.add_trace(go.Scatter(
    x=days,
    y=tempsJuly,
    name= "July Temperature",
    line=dict(color="orange",width=4)
))
layout=fig.update_layout(
    title="Tempareture difference",
    ...
    legend=dict(
        x=0,
        y=0,
        bgcolor='rgba(120,160,110,0)',
        bordercolor='rgba(120,160,110,0)'
    ),
    barmode='group',
    bargap=0.15,
    bargroupgap=0.2
